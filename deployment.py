...
def authentication(CLIENT_REALM, CLIENT_ID, CLIENT_KEY):
    ...
    iam_url_dev = f"https://iam-auth-ssr.dev.stackspot.com/{CLIENT_REALM}/oidc/oauth/token"
...
def deployment(application_name, runtime_name, deploy_headers):
    ...
    stackspot_cloud_deployments_url_dev = "https://cloud-cloud-platform-api.dev.stackspot.com/v1/deployments"
    r2 = requests.post(
            url=stackspot_cloud_deployments_url_dev, 
...
def check_deployment_status(application_name, runtime_name, deployment_id, application_id, deploy_headers):
    stackspot_cloud_deployments_details_url_dev = f"https://cloud-cloud-platform-api.dev.stackspot.com/v1/deployments/details/{deployment_id}"
    application_portal_url_dev = "https://cloud.dev.stackspot.com/applications"
    ...
    while True:
        ...
        r3 = requests.get(
            url=stackspot_cloud_deployments_details_url_dev, 
            headers=deploy_headers
        )
        ...
        if r3.status_code == 200:
            ...
            if deployment_status == "UP":
                ...
                print(f"📊 Check the application status on {application_portal_url_dev}/{application_id}/?tabIndex=0")
